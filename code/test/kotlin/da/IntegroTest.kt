...
class CommentTest {
    ...
    fun updateNotValidComment() {
        ...
        assertThrows<ValidationException> { facade.updateComment(tmp) }
    }
    ...
    fun deleteComment() {
        ...
        assertThrows<NotFoundException> {
            transaction {
                ...
                obj?.toEntity() ?: throw NotFoundException("Comment with id = $id not found")
            }
        }
    }
...
class IngredientTest {
    ...
    fun createIngredientNotUniq() {
        ...
        assertThrows<AlreadyExistException> { facade.createIngredient(tmp) }
    }
    ...
    fun createNotValidIngredient() {
        ...
        assertThrows<ValidationException> { facade.createIngredient(tmp) }
    }
    ...
    fun updateIngredient() {
        ...
        val actual = transaction {
            ...
            obj?.toEntity() ?: throw NotFoundException("Ingredient with id = $id not found")
        }
    ...
    fun updateNotValidIngredient() {
        ...
        assertThrows<ValidationException> { facade.updateIngredient(tmp) }
    }
    ...
    fun findByNameIngredientNotExist() {
        assertThrows<NotFoundException> { facade.findByNameIngredient("name9") }
    }
...
class RecipeTest {
    ...
    fun createNotValidRecipe() {
        ...
        assertThrows<ValidationException> { facade.createRecipe(tmp) }
    }
    ...
    fun updateNotValidRecipe() {
        ...
        assertThrows<ValidationException> { facade.updateRecipe(tmp) }
    }
    ...
    fun deleteRecipe() {
        ...
        assertThrows<NotFoundException> {
            transaction {
                ...
                obj?.toEntity() ?: throw NotFoundException("Recipe with id = $id not found")
            }
        }
    }
    ...
    fun addToFavorite() {
        ...
        val tmp = transaction {
            SavedRecipeTable.findById(16) ?: throw NotFoundException("")
        }
    ...
    fun addComment() {
        ...
        val tmpUser = transaction {
            UserTable.findById(id)?.toEntity() ?: throw NotFoundException("User with id = $id not found")
        }
        ...
        val actual1 = transaction {
            CommentTable.findById(comId)?.toEntity() ?: throw NotFoundException("Comment with id = $id not found")
        }
    ...
    fun addNotValidComment() {
        assertThrows<ValidationException> { facade.addComment(1u, "", 1u) }
    }
...
class PublishTest {
    ...
    fun acceptRecipePublication() {
        ...
        val actual = transaction {
            RecipeTable.findById(id.toInt())?.published ?: throw NotFoundException("Recipe with id = $id not found")
        }
...
class UserTest {
    ...
    fun updateNotValidUser() {
        ...
        assertThrows<ValidationException> { facade.updateUser(tmp) }
    }
...
class AccountTest {
    ...
    fun registerNotUniq() {
        ...
        assertThrows<AlreadyExistException> { facade.register(login, password) }
    }
    ...
    fun registerNotValid() {
        ...
        assertThrows<ValidationException> { facade.register(login, password) }
    }
