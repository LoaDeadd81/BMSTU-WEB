...
var StageMockData: Array<Stage> = arrayOf(
    Stage(0u, 30u, "description0", 1u, IngredientInStageMockData.toList()),
    Stage(1u, 31u, "description1", 2u, IngredientInStageMockData.toList()),
    Stage(2u, 32u, "description2", 3u, IngredientInStageMockData.toList()),
    Stage(3u, 33u, "description3", 4u, IngredientInStageMockData.toList()),
    Stage(4u, 34u, "description4", 5u, IngredientInStageMockData.toList())
)
